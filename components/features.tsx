...
import FeaturesBg from '@/public/logos/fixupe_logo.png'
import FeaturesElement from '@/public/images/3D/ski-2033184_1920.jpg'
          ...
          <div className="md:grid md:grid-cols-12 md:gap-6">
            ...
            <div className="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-7 lg:col-span-6 md:mt-6" data-aos="fade-right">
              ...
              <div className="mb-8 md:mb-0">
                ...
                >
                  <div>
                    <div className="font-bold leading-snug tracking-tight mb-1">Sales Tools</div>
                    <div className="text-gray-600">Our sales tools are the best in the industry and an assurance to scale your business the AI way.</div>
                  </div>
                  <div className="flex justify-center items-center w-8 h-8 bg-white rounded-full shadow flex-shrink-0 ml-3">
                    <svg className="w-3 h-3 fill-current" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
                ...
                >
                  <div>
                    <div className="font-bold leading-snug tracking-tight mb-1">Essential Business Tools</div>
                    <div className="text-gray-600">Fixupe is a platform that provides essential business tools on a single platform.</div>
                  </div>
                  <div className="flex justify-center items-center w-8 h-8 bg-white rounded-full shadow flex-shrink-0 ml-3">
                    <svg className="w-3 h-3 fill-current" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
